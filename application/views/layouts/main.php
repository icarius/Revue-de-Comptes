...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?php echo site_url('assets/vendor/datatables/dataTables.bootstrap4.css'); ?>" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html"><?php echo $this->config->item('site_name'); ?></a>
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
        ...
        echo'<li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-user-circle fa-fw"></i> '.$this->session->userdata('displayname').' 
          </a>
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            <p>'.count(scandir(ini_get("session.save_path"))).'</p>
            <div class="dropdown-divider"></div>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="<?php echo site_url() ?>rh">
            <i class="fas fa-fw fa-table"></i>
            <span>Infos RH</span></a>
        </li>
		<li class="nav-item active">
          <a class="nav-link" href="<?php echo site_url() ?>ad">
            <i class="fas fa-fw fa-table"></i>
            <span>Infos AD</span></a>
        </li>
		
        <?php $group = array("GGS-LEN-SupportDSI-Admin", "GG-LEN-D.R.H");
			
		if (in_array($this->session->has_userdata('Group'),$group)) {
        echo '<li class="nav-item">
          <a class="nav-link" href="'.site_url().'Search">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Suivi passage</span></a>
        </li>}'; 
        }?>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php if($breadcrumb !=""){ echo $breadcrumb; } else { echo'Tables'; } ?></li>
          </ol>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © <?php echo $this->config->item('site_name'); ?> 2018</span>
            </div>
          </div>
        </footer>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="<?php echo site_url() ?>Logout">Déconnexion</a>
          </div>
        </div>
      </div>
    </div>
