...
class PCPass extends CI_Controller {
    ...
    public function index(){
        ...
        // Get rows
        $data['members'] = $this->models->getRowsPCPASS();
        $array = array('returnType' => 'count');
        $data['count'] =  $this->models->getRowsPCPASS($array);
        
        // Load the list page view
        //$this->load->view('rh/index', $data);

        $data['breadcrumb'] = "Compte PCPASS";
        $data['_view'] = 'pcpass/index';
    ...
    public function import()
	{
        ...
        if($this->input->post('importSubmit')){
            ...
            if($this->form_validation->run() == true){
                ...
                $column_headers = array('nom','prenom','matricule','info','photo');
                ...
                $this->models->insertPCPASS($memData);
